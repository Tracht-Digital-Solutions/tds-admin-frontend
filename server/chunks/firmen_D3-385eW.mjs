...
function CustomersList() {
	...
	const load = async () => {
		...
		if (res === null) setStatus("Firmen konnten nicht geladen werden — die API ist nicht erreichbar.");
		else if (res.ok) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(Collapse, {
				open: editing !== null,
				children: editing !== null ? /* @__PURE__ */ jsxs("div", {
			...
			editing === null ? /* @__PURE__ */ jsx("button", {
				type: "button",
				className: "btn btn-primary",
				onClick: startNew,
				children: "Neue Firma"
