...
import { D as apiFetch, g as ConfirmDialog, k as toast, t as $$Layout, x as Spinner } from "./Layout_kCpQGkaf.mjs";
import { a as Presence, n as AnimatedList, o as TabIndicator, r as Collapse, t as AnimatedItem } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			blogs.length > 1 ? /* @__PURE__ */ jsx("div", {
				...
				children: blogs.map((b) => /* @__PURE__ */ jsxs("button", {
					type: "button",
					...
					children: [b.name, b.blog_key === selected?.blog_key ? /* @__PURE__ */ jsx(TabIndicator, { group: "blog-picker" }) : null]
				}, b.id))
			}) : null,
			selected ? /* @__PURE__ */ jsx(Presence, {
				view: selected.blog_key,
				children: /* @__PURE__ */ jsx(BlogPosts, { blog: selected }, selected.blog_key)
			}) : null
		]
	});
}
...
function BlogPosts({ blog }) {
	...
	*/
	...
	const editor = editing ? /* @__PURE__ */ jsx(PostEditor, {
	...
	const list = /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			postsQuery.loading ? /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Spinner, {}) }) : posts.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				children: posts.map((p) => /* @__PURE__ */ jsxs(AnimatedItem, {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			loading ? /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Spinner, {}) }) : authors.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				"aria-busy": stale,
				children: authors.map((a) => /* @__PURE__ */ jsxs(AnimatedItem, {
					className: "tds-list__row",
					children: [
			...
			importable.length > 0 ? /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("label", {
					className: "tds-field-row",
					children: [/* @__PURE__ */ jsx("span", { children: "Aus Panel-Nutzer" }), /* @__PURE__ */ jsxs("select", {
						className: "field-boxed",
						value: pickedUser,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("label", {
						className: "tds-field-row",
						children: [/* @__PURE__ */ jsx("span", { children: "Gast-Autor" }), /* @__PURE__ */ jsx("input", {
							className: "field-boxed",
							value: name,
					...
					/* @__PURE__ */ jsxs("label", {
						className: "tds-field-row",
						children: [/* @__PURE__ */ jsx("span", { children: "Kurzbio" }), /* @__PURE__ */ jsx("input", {
							className: "field-boxed",
							value: bio,
					...
					/* @__PURE__ */ jsxs("label", {
						className: "tds-field-row",
						children: [/* @__PURE__ */ jsx("span", { children: "Avatar-URL" }), /* @__PURE__ */ jsx("input", {
							className: "field-boxed",
							value: avatar,
