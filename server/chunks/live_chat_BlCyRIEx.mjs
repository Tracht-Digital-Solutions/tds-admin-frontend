...
import { a as Presence, n as AnimatedList, t as AnimatedItem } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				loadFailed ? /* @__PURE__ */ jsx("p", {
					...
					role: "alert",
					children: "Chats konnten nicht geladen werden — die API ist nicht erreichbar."
				}) : null,
				sessions.length === 0 ? /* @__PURE__ */ jsx("p", {
					className: "marginalia",
					children: "Keine Chats."
				}) : /* @__PURE__ */ jsx(AnimatedList, { children: sessions.map((s) => /* @__PURE__ */ jsx(AnimatedItem, { children: /* @__PURE__ */ jsxs("button", {
					type: "button",
...
function ChatThread({ sessionId, onChanged }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			offline ? /* @__PURE__ */ jsx("p", {
				className: "tds-alert tds-alert--warning",
				role: "status",
				children: "Die API ist nicht erreichbar — neue Nachrichten erscheinen, sobald sie wieder antwortet."
			}) : null,
			/* @__PURE__ */ jsxs("div", {
