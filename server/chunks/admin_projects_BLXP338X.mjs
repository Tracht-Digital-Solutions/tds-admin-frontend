		...
		children: [
			...
			/* @__PURE__ */ jsx(Presence, {
				...
				children: /* @__PURE__ */ jsxs("form", {
					...
					children: [
						/* @__PURE__ */ jsx("h2", { children: editingId ? `Projekt #${editingId} bearbeiten` : "Neues Projekt" }),
						/* @__PURE__ */ jsxs("div", {
			...
			projects.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				className: "tds-list",
				children: projects.map((p) => /* @__PURE__ */ jsxs(AnimatedItem, {
					className: "tds-card",
					children: [/* @__PURE__ */ jsxs("header", {
						...
						className: "tds-stack",
						children: [/* @__PURE__ */ jsx(AnimatedList, {
							as: "ol",
							children: (p.milestones ?? []).map((m) => /* @__PURE__ */ jsxs(AnimatedItem, { children: [
								/* @__PURE__ */ jsx("button", {
									type: "button",
