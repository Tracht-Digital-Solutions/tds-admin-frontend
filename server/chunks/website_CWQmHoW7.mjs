import { a as renderComponent, f as renderTemplate, p as maybeRenderHead, q as __exportAll } from "./server_BhrUZIgD.mjs";
import { t as createComponent } from "./compiler_CzejKBGG.mjs";
import { D as apiFetch, O as apiUrl, k as toast, t as $$Layout, x as Spinner } from "./Layout_kCpQGkaf.mjs";
import { a as Presence, o as TabIndicator, r as Collapse } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
import { n as staleClass, r as useCachedJson, t as invalidate } from "./data_B7FM-8EF.mjs";
...
function LegalDocs({ siteKey }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("h2", { children: "Rechtsdokumente (PDF)" }),
			/* @__PURE__ */ jsx("p", {
...
var SECTION_SCHEMAS = {
	home_hero: [
		{
			key: "eyebrow",
			label: "Zielgruppe (über der Überschrift)",
			type: "text"
		},
		{
			key: "headline",
		...
		{
			key: "sub",
			label: "Nutzen (Untertext, *Betonung* mit Sternchen)",
			type: "textarea"
		},
		{
			key: "cta1",
			label: "Button 1 (Erstgespräch)",
			type: "text"
		},
		{
			key: "cta2",
	...
	home_trust: [{
		...
		itemFields: [
			...
			{
				key: "text",
				label: "Text – {name}, {town} und {rate} setzt die Seite ein",
				type: "textarea"
			},
			{
				key: "linkLabel",
	...
	references_home: [
		...
		{
			key: "label",
			label: "Hinweis zur Veröffentlichung",
			type: "textarea"
		}
	],
	first_call: [
	...
	website_demos: [
		...
		{
			key: "intro",
			label: "Einleitung (Startseite)",
			type: "textarea"
		},
		{
			key: "serviceIntro",
			label: "Einleitung (Leistung Webauftritt)",
			type: "textarea"
		},
		{
			key: "headlineSingle",
			label: "Überschrift bei nur einer Beispielseite",
			type: "text"
		},
		{
			key: "introSingle",
			label: "Einleitung bei nur einer Beispielseite (Startseite)",
			type: "textarea"
		},
		{
	...
	contact: [
		...
		{
			key: "reasons",
			label: "Anliegen (Auswahl im Formular)",
			type: "stringlist",
			itemLabel: "Anliegen"
		}
	],
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			sites.length > 1 ? /* @__PURE__ */ jsx("div", {
				...
				children: sites.map((s) => /* @__PURE__ */ jsxs("button", {
					type: "button",
					...
					children: [s.name, s.site_key === selected?.site_key ? /* @__PURE__ */ jsx(TabIndicator, { group: "cms-site" }) : null]
				}, s.id))
			}) : null,
		...
		children: [
			...
			blocksQuery.loading ? /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Spinner, {}) }) : /* @__PURE__ */ jsxs(Fragment$1, { children: [
				...
				/* @__PURE__ */ jsx("nav", {
					...
					children: pages.map((p) => /* @__PURE__ */ jsxs("button", {
						type: "button",
						...
						children: [p.label, p.id === page?.id ? /* @__PURE__ */ jsx(TabIndicator, { group: "cms-page" }) : null]
					}, p.id))
				}),
				page ? /* @__PURE__ */ jsx(Presence, {
					view: page.id,
					children: /* @__PURE__ */ jsx(PageSections, {
						page,
				...
				/* @__PURE__ */ jsx(Presence, {
					view: page && sectionKey ? `section-${sectionKey}` : "none",
					children: page && sectionKey ? /* @__PURE__ */ jsx(BlockEditor, {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("h2", { children: "Automatische Übersetzung" }),
					/* @__PURE__ */ jsx("p", {
						className: "marginalia",
...
function PageSections({ page, stale, activeSection, activeLang, isMachine, isStored, onPick }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("h2", { children: page.label }), page.path ? page.pathEn ? /* @__PURE__ */ jsxs("span", {
