...
import { D as apiFetch, g as ConfirmDialog, k as toast, t as $$Layout } from "./Layout_kCpQGkaf.mjs";
import { n as AnimatedList, o as TabIndicator, t as AnimatedItem } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
...
function TabButton({ active, onClick, children }) {
	return /* @__PURE__ */ jsxs("button", {
		...
		className: active ? "chip tds-tab chip-active" : "chip tds-tab",
		onClick,
		children: [children, active ? /* @__PURE__ */ jsx(TabIndicator, { group: "wiki-content" }) : null]
	});
}
var emptyFaq = {
	lang: "de",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("form", {
				...
				children: [
					/* @__PURE__ */ jsx("h2", { children: typeof draft.id === "number" ? "FAQ bearbeiten" : "Neue FAQ" }),
					/* @__PURE__ */ jsxs("div", {
						className: "grid",
			...
			loadFailed ? /* @__PURE__ */ jsx("p", {
				className: "tds-alert tds-alert--danger",
				role: "alert",
				children: "FAQ-Einträge konnten nicht geladen werden — die API ist nicht erreichbar."
			}) : null,
			/* @__PURE__ */ jsx(AnimatedList, {
				className: "tds-list",
				children: rows.map((r) => /* @__PURE__ */ jsxs(AnimatedItem, {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("form", {
				...
				children: [
					/* @__PURE__ */ jsx("h2", { children: typeof draft.id === "number" ? "Artikel bearbeiten" : "Neuer Artikel" }),
					/* @__PURE__ */ jsxs("div", {
						className: "grid",
						children: [/* @__PURE__ */ jsxs("label", { children: [/* @__PURE__ */ jsx("span", { children: "Sprache" }), /* @__PURE__ */ jsxs("select", {
							className: "field-boxed",
			...
			loadFailed ? /* @__PURE__ */ jsx("p", {
				className: "tds-alert tds-alert--danger",
				role: "alert",
				children: "Artikel konnten nicht geladen werden — die API ist nicht erreichbar."
			}) : null,
			/* @__PURE__ */ jsx(AnimatedList, {
				className: "tds-list",
				children: rows.map((r) => /* @__PURE__ */ jsxs(AnimatedItem, {
