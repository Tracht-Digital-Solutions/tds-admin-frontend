...
import { A as applyThemePreference, _ as FormAlert, a as API_BASE, c as fetchMe, h as Avatar, j as readThemePreference, k as toast, l as frontendFetch, m as LOGIN_URL, o as AUTH_API_URL, t as $$Layout, u as invalidateMe, x as Spinner } from "./Layout_kCpQGkaf.mjs";
import { a as Presence, o as TabIndicator } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: TABS.map((t) => /* @__PURE__ */ jsxs("button", {
				...
				className: `chip tds-tab ${tab === t.id ? "chip--info" : "chip--neutral"}`,
				onClick: () => setTab(t.id),
				children: [t.label, tab === t.id ? /* @__PURE__ */ jsx(TabIndicator, { group: "profil" }) : null]
			}, t.id))
