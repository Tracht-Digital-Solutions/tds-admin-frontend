...
import { n as AnimatedList, t as AnimatedItem } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						"Läuft seit ",
						timeRange(running.started_at, null),
			...
			/* @__PURE__ */ jsxs("div", {
				className: "tds-stack",
				children: [
					/* @__PURE__ */ jsx("h2", { children: "Letzte Einträge" }),
					loadFailed ? /* @__PURE__ */ jsx("p", {
						className: "tds-alert tds-alert--danger",
						role: "alert",
						children: "Zeiten konnten nicht geladen werden — die API ist nicht erreichbar."
					}) : null,
					entries === null ? /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Spinner, {}) }) : entries.length === 0 ? /* @__PURE__ */ jsx("p", {
						className: "text-sm opacity-70",
						children: "Noch keine Einträge."
					}) : /* @__PURE__ */ jsx(AnimatedList, {
						className: "tds-list",
						children: entries.map((e) => /* @__PURE__ */ jsxs(AnimatedItem, {
							...
							children: [
								...
								/* @__PURE__ */ jsx("span", {
									...
									children: timeRange(e.started_at, e.ended_at)
								}),
