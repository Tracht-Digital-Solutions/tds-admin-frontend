import { C as createAstro, d as renderTemplate, f as maybeRenderHead, m as addAttribute, t as spreadAttributes, x as unescapeHTML, z as __exportAll } from "./server_LvAcRe-s.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./noop_CXiMxVf8.mjs").catch((e) => {
