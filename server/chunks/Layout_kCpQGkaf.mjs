import { C as unescapeHTML, G as object, H as array, K as string, T as createAstro, U as boolean, V as _enum, W as number, _ as createRenderInstruction, a as renderComponent, f as renderTemplate, g as defineScriptVars, h as addAttribute, l as renderSlot, m as renderHead, n as renderTransition, o as Fragment$2, p as maybeRenderHead } from "./server_BhrUZIgD.mjs";
...
//#endregion
//#region node_modules/@tracht-digital-solutions/tds-shared/dist/chunk-ZCT3ZR3R.js
...
//#endregion
//#region node_modules/@tracht-digital-solutions/tds-shared/dist/chunk-6MKPKRZM.js
var translations = {
	de: {
		nav: {
			about: "Über mich",
...
//#endregion
//#region node_modules/@tracht-digital-solutions/tds-shared/dist/chunk-SPND4ICT.js
...
var spring = {
	type: "spring",
	bounce: 0,
	visualDuration: durations.slow / 1e3
};
var presence = {
	enter: {
		opacity: 0,
...
function Avatar({ name, src, seed, size = "md", decorative = false, className }) {
	...
	const variant = CATEGORICAL_CHIP_VARIANTS[hash$1(String(seed ?? label ?? "")) % CATEGORICAL_CHIP_VARIANTS.length];
...
function useCollapse(wanted) {
	const [collapse, setCollapse] = useState(null);
	useEffect(() => {
		if (!wanted || collapse) return;
		let live = true;
		import("./react_D2cgX0y6.mjs").then((n) => n.t).then((loaded) => {
...
function FormAlert({ message }) {
	...
	const alert = message ? /* @__PURE__ */ jsxs("p", {
...
function ToastContent({ item, dismissLabel, onDismiss }) {
...
function useToastMotion() {
	...
	useEffect(() => {
		let live = true;
		import("./toastMotion-B7JEXYIC_D-Bh4FQO.mjs").then((loaded) => {
...
function ToastHost({ lang = "de" } = {}) {
	...
	const toastClass = (item) => `tds-toast tds-toast--${item.variant}`;
	const content = (item) => /* @__PURE__ */ jsx(ToastContent, {
		item,
		dismissLabel: t.dismiss,
		onDismiss: dismiss
	});
	const region = (list) => motion ? /* @__PURE__ */ jsx(motion.AnimatedToasts, {
		items: list,
		swipeable: coarse,
		...
		onDismiss: dismiss,
		onHold: setPaused
	}) : list.map((item) => /* @__PURE__ */ jsx("div", {
		className: toastClass(item),
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: region(urgent)
		}), /* @__PURE__ */ jsx("div", {
			className: "tds-toast-region",
			role: "status",
			"aria-live": "polite",
			"aria-relevant": "additions",
			children: region(polite)
		})]
	});
}
...
var $$Layout = createComponent(($$result, $$props, $$slots) => {
	...
	const pageSwap = {
		old: {
			name: "astroFadeOut",
			duration: "var(--tds-dur-fast)",
			easing: "var(--tds-ease-out)",
			fillMode: "both"
		},
		new: {
			name: "astroFadeIn",
			duration: "var(--tds-dur-base)",
			easing: "var(--tds-ease-out)",
			fillMode: "both"
		}
	};
...
//#endregion
export { applyThemePreference as A, presence as C, apiFetch as D, emptyPlacement as E, resolveChipVariant as M, renderScript as N, apiUrl as O, listItem as S, transitions as T, FormAlert as _, API_BASE as a, SkeletonText as b, fetchMe as c, membershipIds as d, $$Icon as f, ConfirmDialog as g, Avatar as h, getActiveCompany as i, readThemePreference as j, toast as k, frontendFetch as l, LOGIN_URL as m, hueForKey as n, AUTH_API_URL as o, FRONTEND_TARGET as p, widgetIcon as r, CUSTOMER_API_URL as s, $$Layout as t, invalidateMe as u, ProductCard as v, spring as w, Spinner as x, Skeleton as y };
