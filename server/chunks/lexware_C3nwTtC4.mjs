...
import { D as apiFetch, k as toast, t as $$Layout } from "./Layout_kCpQGkaf.mjs";
import { a as Presence, n as AnimatedList, o as TabIndicator, t as AnimatedItem } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("nav", {
			...
			children: [
				...
				["contacts", "Kontakte"],
				["invoices", "Rechnungen"]
			].map(([id, label]) => /* @__PURE__ */ jsxs("button", {
				type: "button",
				role: "tab",
				"aria-selected": tab === id,
				className: tab === id ? "chip tds-tab chip-active" : "chip tds-tab",
				onClick: () => setTab(id),
				children: [label, tab === id ? /* @__PURE__ */ jsx(TabIndicator, { group: "lexware" }) : null]
			}, id))
		}), /* @__PURE__ */ jsxs(Presence, {
			view: tab,
...
function CustomersTab() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx("h2", { children: "Kunden" }),
			/* @__PURE__ */ jsxs(AnimatedList, {
				className: "tds-list",
				children: [customers.map((c) => /* @__PURE__ */ jsx(AnimatedItem, { children: /* @__PURE__ */ jsxs("button", {
					type: "button",
				...
				}) }, c.id)), customers.length === 0 ? /* @__PURE__ */ jsx(AnimatedItem, {
					className: "opacity-70",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("h3", { children: "Neuer Kunde" }),
					/* @__PURE__ */ jsxs("label", {
					...
					/* @__PURE__ */ jsxs("label", {
						className: "tds-field-row",
						children: [/* @__PURE__ */ jsx("span", { children: "E-Mail" }), /* @__PURE__ */ jsx("input", {
							className: "field-boxed",
							type: "email",
					...
					/* @__PURE__ */ jsxs("label", {
						className: "tds-field-row",
						children: [/* @__PURE__ */ jsx("span", { children: "Stundensatz netto (€/h)" }), /* @__PURE__ */ jsx("input", {
							className: "field-boxed",
							type: "number",
							min: "0",
							step: "0.01",
		...
		] }), /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Presence, {
			view: selected ? `customer-${selected.id}` : "none",
			children: selected ? /* @__PURE__ */ jsx(CustomerDetail, {
				customer: selected,
...
function CustomerDetail({ customer, onChanged, onPush }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "lx-detail",
		children: [
			/* @__PURE__ */ jsx("h2", { children: customer.name }),
			/* @__PURE__ */ jsxs("p", {
			...
			/* @__PURE__ */ jsx("h3", { children: "Projekte" }),
			/* @__PURE__ */ jsxs("ul", {
				className: "tds-list",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("label", {
						className: "tds-field-row",
						children: [/* @__PURE__ */ jsx("span", { children: "Projekttitel" }), /* @__PURE__ */ jsx("input", {
							className: "field-boxed",
							type: "text",
					...
					/* @__PURE__ */ jsxs("label", {
						className: "tds-field-row",
						children: [/* @__PURE__ */ jsx("span", { children: "Stundensatz (€/h)" }), /* @__PURE__ */ jsx("input", {
							className: "field-boxed",
							type: "number",
							min: "0",
							step: "0.01",
...
function InvoicesTab() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("h2", { children: "Bisherige Exporte" }),
			/* @__PURE__ */ jsxs("table", {
				className: "tds-table",
				tabIndex: 0,
				role: "region",
