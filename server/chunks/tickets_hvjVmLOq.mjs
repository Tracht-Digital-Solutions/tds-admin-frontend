...
function TicketBoard() {
	...
	const board = /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(Collapse, {
				open: creating,
				children: /* @__PURE__ */ jsx(NewTicketForm, { onCreated: () => {
					setCreating(false);
					loadList();
				} })
			}),
			tickets === null ? /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Spinner, {}) }) : tickets.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				className: "tds-list",
				children: tickets.map((t) => /* @__PURE__ */ jsxs(AnimatedItem, {
	...
	return /* @__PURE__ */ jsx(Presence, {
		view: detail ? `ticket-${detail.id}` : "board",
		children: detail ? /* @__PURE__ */ jsx(TicketDetailView, {
			ticket: detail,
			onBack: () => {
				setDetail(null);
				loadList();
...
function TicketDetailView({ ticket, onBack, onReload }) {
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [
			...
			ticket.attachments.length > 0 ? /* @__PURE__ */ jsx(AnimatedList, {
				className: "ticket-attachments",
				children: ticket.attachments.map((a) => /* @__PURE__ */ jsx(AnimatedItem, { children: /* @__PURE__ */ jsx("a", {
			...
			/* @__PURE__ */ jsx(AnimatedList, {
				...
				children: ticket.comments.map((c) => /* @__PURE__ */ jsxs(AnimatedItem, {
