...
import { _ as FormAlert, g as ConfirmDialog, k as toast, l as frontendFetch, o as AUTH_API_URL, t as $$Layout, x as Spinner } from "./Layout_kCpQGkaf.mjs";
import { a as Presence, n as AnimatedList, r as Collapse, t as AnimatedItem } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
import { a as fetchCompanyPolicy, c as fetchPermissionCatalog, d as saveCompanyPolicy, h as fetchCompanies, i as describeFailure, l as listGroups, m as PermissionMatrix, n as createGroup, p as updateGroup, r as deleteGroup, s as fetchGroups } from "./companyAdmin_CpEc89FJ.mjs";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(Collapse, {
				open: draft !== null,
				children: draft !== null && /* @__PURE__ */ jsxs("form", {
					className: "tds-card p-4 space-y-4",
					onSubmit: save,
					children: [
						/* @__PURE__ */ jsx("h3", {
			...
			groups.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				className: "tds-stack",
				children: groups.map((group) => /* @__PURE__ */ jsx(AnimatedItem, {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			users === null ? /* @__PURE__ */ jsx("p", {
				...
				className: "tds-stack",
				children: users.map((u) => /* @__PURE__ */ jsx(AnimatedItem, {
					className: "tds-card p-4",
					children: /* @__PURE__ */ jsx(Presence, {
						view: editingId === u.id ? "edit" : "view",
