import { S as unescapeHTML, Z as __exportAll, d as renderTemplate, f as maybeRenderHead, m as addAttribute, t as spreadAttributes, w as createAstro } from "./server_CzwR-3SR.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./noop_Bej3qRXv.mjs").catch((e) => {
