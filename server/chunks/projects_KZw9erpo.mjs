...
import { D as apiFetch, t as $$Layout, x as Spinner } from "./Layout_kCpQGkaf.mjs";
import { n as AnimatedList, r as Collapse, t as AnimatedItem } from "./chunk-K3B6PMZC_OR-NiCIk.mjs";
...
function ProjectList() {
	...
	return /* @__PURE__ */ jsx(AnimatedList, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						loadingDetail ? /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Spinner, {}) }) : milestones.length === 0 ? /* @__PURE__ */ jsx("p", {
							...
							as: "ol",
							className: "tds-list",
							children: milestones.map((m) => /* @__PURE__ */ jsxs(AnimatedItem, {
